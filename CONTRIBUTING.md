# Contributing to Flight Asset

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

You want to contribute to Flight Asset? Welcome! Please read this
...
You can help Flight Asset by helping others who use it and need support.

## Analyse Issues

Analysing issue reports can be a lot of effort. Any help is welcome!
Go to [the GitHub issue tracker](https://github.com/alces-flight/alces-flight/flight-asset-cli/issues?state=open)
...
If you find a bug - behaviour of Flight Asset code or documentation
...
[GitHub issue tracker for Flight Asset](https://github.com/alces-flight/alces-flight/flight-asset-cli/issues/new)
to report the issue.
...
We want to improve the quality of Flight Asset and good bug reports are
...
Flight Asset is Open Source and comes without warranty.
...
Flight Asset in order to fix bugs or to implement new features.
...
2. **Not all proposed contributions can be accepted**. Some features
   ...
   the overall direction of Flight Asset and really improve it. The more
...
applied to Flight Asset itself.

In particular you need to agree to the Contributor License Agreement,
which can be [found
here](https://www.clahub.com/agreements/alces-flight/alces-flight/flight-asset-cli). This
...
8. Wait for our code review and approval, possibly enhancing your
   change on request.
    - Note that the Flight Asset developers also have their regular
