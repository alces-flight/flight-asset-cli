...
module FlightAsset
  module Commands
    class RenameContainer < FlightAsset::Command
      ...
      def run
        ...
        raise InputError, <<~ERROR.chomp if request_new_asset_containers_record
      ...
      def request_old_asset_containers_record
        request_asset_containers_record_by_name(old_name, error: true)
      end

      def request_new_asset_containers_record
        request_asset_containers_record_by_name(new_name, error: false)
      end
    end
  end
end
